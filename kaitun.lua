...
elseif placeId == 116495829188952 then
    ...
    task.spawn(function()
        local createPartyEvent = replicatedStorage:WaitForChild("Shared"):WaitForChild("Network"):WaitForChild("RemoteEvent"):WaitForChild("CreateParty")
        local args = {{isPrivate = true, maxMembers = 1, trainId = "default", gameMode = "Normal"}}
        while true do
